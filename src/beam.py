...
class Beam:
    """
    This class represents the preprocessing of a beam structure, assembling the global stiffness and mass matrices
    by stacking local matrices from each finite element.
